...
# Small .022 p-value indicates significance, and the other R2 is small-ish at .2 representing that the correlation could be just from variation effects. It is not that small, so it's a sort of in a grey area.
```
